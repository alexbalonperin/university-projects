...
#define __DRIVER_CLASS__ PSODriver    // put here the name of your driver class
#define __DRIVER_INCLUDE__ "PSODriver.h" // put here the filename of your driver h\\eader
        ...
        ***********************************************************************************/
        do
        {
            ...
            if (select(socketDescriptor+1, &readSet, NULL, NULL, &timeVal))
            {
                ...
                if (numRead < 0)
                {
                   // cerr << "1) didn't get response from server...";
                }
		else
		{
